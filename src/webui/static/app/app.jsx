  ...
  return (
    <div className="setup-shell" data-theme={theme}>
      <div className="setup-topbar">
        ...
        <button className="iconbtn" title={theme === "dark" ? t("topbar.switchToLight") : t("topbar.switchToDark")} onClick={onToggleTheme}>
          {theme === "dark" ? "◐" : "◑"}
        </button>
      </div>
  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-right">
        ...
        <button className="iconbtn" title={theme === "dark" ? t("topbar.switchToLight") : t("topbar.switchToDark")}
